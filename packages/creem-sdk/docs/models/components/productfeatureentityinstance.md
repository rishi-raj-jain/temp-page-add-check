...
```typescript
import { ProductFeatureEntityInstance } from "creem/models/components";

let value: ProductFeatureEntityInstance = {
  id: "<id>",
  mode: "prod",
...
| `status`                                                                                       | [components.ProductFeatureEntityStatus](../../models/components/productfeatureentitystatus.md) | :heavy_check_mark:                                                                             | The status of the license instance.                                                            | active                                                                                         |
