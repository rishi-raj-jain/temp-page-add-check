...
export const tool$customerCreditsReverseTransaction: ToolDefinition<
  typeof args
> = {
  name: "customer-credits-reverse-transaction",
...
Reverse a previous credit or debit on this account. Creates a new transaction that undoes the original, preserving the full history.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await customerCreditsReverseTransaction(
      client,
      args.id,
